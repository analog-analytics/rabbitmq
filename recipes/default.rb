...
when 'debian'
  ...
  if node['rabbitmq']['use_distro_version']
    ...
    deb_package = "#{node['rabbitmq']['package_mirror']}/v#{node['rabbitmq']['version']}/rabbitmq-server_#{node['rabbitmq']['version']}-1_all.deb"
...
when 'rhel', 'fedora'
  ...
  if node['rabbitmq']['use_distro_version']
    ...
    rpm_package = "#{node['rabbitmq']['package_mirror']}/v#{node['rabbitmq']['version']}/rabbitmq-server-#{node['rabbitmq']['version']}-1.noarch.rpm"
